      ...
      <section className="container-outer pt-28 pb-8" aria-labelledby="contact-hero-title">
        <div className="jelly-surface px-8 py-10">
          ...
          <p className="mt-5 max-w-3xl text-lg text-slate-200">
            Pullsheet closed beta access (iOS TestFlight or Android Play Store), safety reviews, AI for regulated trades, or
            investment conversations. Tell us what you need and we’ll respond quickly.
          </p>
