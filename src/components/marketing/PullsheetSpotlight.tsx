  ...
  return (
    <section id="pullsheet" className="container-outer py-16 text-white">
      <div className="jelly-surface grid gap-10 px-8 py-10 md:grid-cols-2">
        <div>
          <p className="text-xs uppercase tracking-[0.35em] accent-label" id="pullsheet-heading">
            Pullsheet spotlight
          </p>
          ...
          <Link
            ...
            className="accent-pill-outline mt-8 inline-flex items-center rounded-full px-5 py-3 text-sm font-semibold uppercase tracking-[0.2em]"
          >
        ...
        <div className="relative">
          <div
            ...
            style={{ background: "linear-gradient(120deg, hsla(var(--accent) / 0.25), hsla(var(--accent) / 0.12))" }}
          />
